      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          ...
          {hasAccess('supplier', AccessOperationEnum.CREATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/suppliers/create`} passHref legacyBehavior>
            ...
            <Table variant="simple">
              <Thead>
                <Tr>
                  ...
                  {hasAccess('egg_rate', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && <Th>egg_rate</Th>}
                  <Th>Actions</Th>
                </Tr>
              </Thead>
              <Tbody>
