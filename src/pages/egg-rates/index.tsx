...
import { getEggRates, deleteEggRateById } from 'apiSdk/egg-rates';
...
function EggRateListPage() {
  ...
  const handleView = (id: string) => {
    if (hasAccess('egg_rate', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)) {
      router.push(`/egg-rates/view/${id}`);
    }
  };
    ...
    <AppLayout>
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          ...
          {hasAccess('egg_rate', AccessOperationEnum.CREATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/egg-rates/create`} passHref legacyBehavior>
                  ...
                  <Tr cursor="pointer" onClick={() => handleView(record.id)} key={record.id}>
                    ...
                    <Td>
                      {hasAccess('egg_rate', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                        <NextLink href={`/egg-rates/edit/${record.id}`} passHref legacyBehavior>
                          <Button
