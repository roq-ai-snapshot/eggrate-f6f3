...
export const HelpBox: React.FC = () => {
  const ownerRoles: string[] = ['Poultry Farm Manager'];
  const customerRoles: string[] = ['End Consumer'];
  const tenantRoles: string[] = ['Poultry Farm Manager'];
  const addOns: string[] = ['notifications'];
  const applicationName = `eggrate`;
  const tenantName = `Supplier`;
